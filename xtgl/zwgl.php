...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="xtgl/addzw.php" target="dialog" mask="true" width="660" height="152"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138" style="word-break:break-all; word-wrap:break-all;">
		...
		<tbody id="datacontent" >
			...
			$result=mysqli_query($con,"select * from t_duty" );
			...
			$resultnow=mysqli_query($con,"select * from t_duty limit ".$sr.",".$er );
			...
			?>
			  <tr  >
			<td ><?php echo ($a+1);?>
			</td><td ><?php echo $resultnowarray[$a]['dutyname'];?>
            </td><td ><?php echo $resultnowarray[$a]['dutycode'];?>
