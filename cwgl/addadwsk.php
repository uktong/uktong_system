...
function sknewadd(){
	...
	$("#addsk").attr("href","ajax/skcontent.php?travelid="+hotelid);
}
function searchthis(){
	var hotelid=$("#travelsk").val();
...
<!-- 				</td> -->
	<tr> 
			...
			<td >
				...
				</td><td><a class="button" id="addsk" target="ajax" rel="addadwskbox" onclick="sknewadd()"><span>添加</span></a></td>
			</tr>
		</table>
...
<!-- <form onsubmit="return divSearch(this, 'skcontent')"  rel="sscontent" action="ajax/skcontent.php?hotelid=<?php echo $hotel;?>" method="post" >  -->	
	<table class="searchContent">
			...
			<td class="dateRange">
				...
				<td><a class="button" id="searchbutton" target="ajax" rel="addadwskbox" onclick="searchthis()"><span>搜索</span></a></td>
				</tr>
				</table>
