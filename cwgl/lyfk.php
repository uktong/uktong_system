...
<form id="pagerForm" method="post" action="cwgl/lyfk.php">
...
<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" id="jdyfcxform" action="cwgl/lyfk.php" method="post" >
	<div class="searchBar">
		...
		<table class="searchContent">
			...
			<td class="dateRange">
				...
				<input type="text" class="getjgs" name="zts.zts" value="<?php echo @$_POST["zts_zts"];?>" readonly style="width:100px; " suggestFields="zts"  lookupGroup="zts" />
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="cwgl/addlyfk.php" target="dialog" max="true" mask="true"  rel="addadwfk"><span>添加</span></a></li>
		</ul>
...
<!-- 				<th align="center">销售</th> -->
		...
		<tbody id="datacontent" >
			...
			if(@$_POST["search"]==null){
			    $result=mysqli_query($con,"select * from t_sktravel where jgs is not null and dodate between '".$firstday."' and '".$lastday."' ");
			    ...
			    $resultnow=mysqli_query($con,"select * from t_sktravel where jgs is not null and dodate between '".$firstday."' and '".$lastday."'  limit ".$sr.",".$numPerPage );
			    ...
			    $sql.=$_POST["zts_id"]!=""?" and hotel='".$_POST["zts_id"]."'":"";
			  //  $sql.=$_POST["paytype"]!=""?" and paytype='".$_POST["paytype"]."'":"";
			    ...
			    $result=mysqli_query($con,"select * from t_sktravel where hotel is not null  ".$sql );
			    ...
			    @$page=ceil($resultnum/$numPerPage);
			    @$sr=($pageNum-1)*$numPerPage;
			    $resultnow=mysqli_query($con,"select * from t_sktravel where jgs is not null  ".$sql." limit ".$sr.",".$numPerPage );
			    $resultnowarray=mysqli_fetch_all($resultnow,MYSQLI_ASSOC);
			}
			...
			<a href='cwgl/editlyfk.php?id=<?php echo$resultnowarray[$a]['id'];?>' class='btnEdit' id='' target="dialog" max="true" mask="true"  rel="editadwfk" style='color:blue;'>修改</a>
</td></tr>
<?php			
}
