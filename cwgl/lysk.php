...
<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" id="jdyfcxform" action="cwgl/lysk.php" method="post" >
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="cwgl/addlysk.php" target="dialog" max="true" mask="true" rel="addlysk"><span>添加</span></a></li>
		</ul>
...
<!-- 				<th align="center">销售</th> -->
		...
		<tbody id="datacontent" >
			...
			if(@$_POST["search"]==null){
			    $result=mysqli_query($con,"select * from t_sktravel where sk is not null  and dodate between '".$firstday."' and '".$lastday."' ");
			    ...
			    $resultnow=mysqli_query($con,"select * from t_sktravel where sk is not null and dodate between '".$firstday."' and '".$lastday."'  limit ".$sr.",".$numPerPage );
			   ...
			   // $sql.=$_POST["zts_id"]!=""?" and travel='".$_POST["zts_id"]."'":"";
			    ...
			    $result=mysqli_query($con,"select * from t_sktravel where sk is not null  ".$sql );
			    ...
			    @$page=ceil($resultnum/$numPerPage);
			    @$sr=($pageNum-1)*$numPerPage;
			    $resultnow=mysqli_query($con,"select * from t_sktravel where sk is not null  ".$sql." limit ".$sr.",".$numPerPage );
			    $resultnowarray=mysqli_fetch_all($resultnow,MYSQLI_ASSOC);
			}
			...
			<a href='cwgl/editlysk.php?id=<?php echo$resultnowarray[$a]['id'];?>' class='btnEdit' id='' target="dialog" max="true" mask="true" rel="editlysk" style='color:blue;'>修改</a>
</td></tr>
<?php			
}
