...
<form method="post" action="db/addadwfk.php?action=edit&id=<?php echo $id; ?>" onsubmit="return validateCallback(this, dialogAjaxDone)" class="pageForm required-validate" >
<div class="pageHeader">
<h2 class="contentTitle" style="text-align: center;">修改按单位付款</h2>
	...
	<div class="searchBar">
		...
		<table class="searchContent" id="fftable"  cellspacing="0">
			<tr>
				<td >
					酒店:
				<input type="hidden" id="jdianfk" name="jdian555.id" value="<?php echo @$getmsg["hotel"];?>"/>
				<input type="text" class="getjdian555" oninput="getjdian(555);" name="jdian555.jdian555" value="<?php
				...
				?>" suggestFields="jdian555"  readonly  lookupGroup="jdian555" />
