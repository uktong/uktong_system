...
$(".combox").change(function(){
 ...
 <form  onsubmit="return navTabSearch(this);" class="pageForm" action="xyzx/jgsjg.php?action=edit&id=<?php echo $id;?>" method="post"  enctype="multipart/form-data">
...
<!--                          <input name="hotelName" type="text" id="dutycode" ltype="text" ligerui="{width:160}" class="required "  /> -->
				...
				<input type="text" class="required getjgs" readonly name="zts.zts" value=" <?php 
                         $ztsid=$xy['jgs'];
