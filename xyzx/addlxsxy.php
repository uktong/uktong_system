...
<script type="text/javascript" src="ajax/js/main.js"></script>
 <form  onsubmit="return navTabSearch(this);" class="pageForm" action="xyzx/lxsjg.php?action=charu" method="post"  enctype="multipart/form-data">
