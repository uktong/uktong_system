...
?>
<form id="pagerForm" method="post" action="jddaiding/daiding.php">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="jddaiding/daiding.php" method="post" >
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="jddaiding/dingdan.php" target="navTab" rel="add"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138" style="word-break:break-all; word-wrap:break-all;">
		...
		<tbody>
			 ...
			 if(@$_POST["search"]==null){
			     ...
			     $resultnow=mysqli_query($con,"select * from t_groupmanage where teamNumber like '%".$_SESSION["hotelcode"]."%' order by id DESC limit ".$sr.",".$er  );
...
// 			     $sql.=$_POST["zts_id"]!=""?" and groupName='".$_POST["zts_id"]."'":"";
			...
			<a  ".$limitshow." href='jddaiding/showdaiding.php?id=".$resultnowarray[$a]['id']."' class='show' id='' target='navtab' title='查看".$resultnowarray[$a]['id']."' >查看</a>
<a  style='color:blue;' href='jddaiding/editdaiding.php?id=".$resultnowarray[$a]['teamNumber']."' ".$limitedit." class='edit' target='navtab' title='修改".$resultnowarray[$a]['id']."'  >修改</a></td></tr>";
			}
