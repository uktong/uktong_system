...
$getmsgsql=mysqli_query($con, "select * from t_hoteluser where id=".$_GET["id"]);
$getmsg=mysqli_fetch_array($getmsgsql);
?>
 <form  onsubmit="return navTabSearch(this);" class="pageForm" action="zhzx/jdzh.php?action=edit&id=<?php echo $_GET["id"]; ?>" method="post"  enctype="multipart/form-data">
            ...
            <tbody>
                <tr>
                     ...
                     <input type="hidden" name="jdian222.id" value="<?php echo $getmsg["hotel"];?>"/>
				<input type="text" class="required  getjdian222" oninput="getjdian('222')" style="float: left;" name="jdian222.jdian222" value="<?php 
