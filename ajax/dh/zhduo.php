...
<div class="pageHeader">
	<form onsubmit="return dwzSearch(this, 'dialog');" action="xtgl/gsxx.php" method="post" >
	<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138" style="word-break:break-all; word-wrap:break-all;">
		...
		<tbody id="datacontent" >
			...
			<a class="btnSelect" href="javascript:$.bringBack({id:'<?php echo $resultnowarray[$a]['id'];?>', zh<?php echo $i;?>:'<?php echo $resultnowarray[$a]['accountTitle'];?>'})" title="查找带回">选择</a></td>
<?php			
}
