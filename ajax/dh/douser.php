...
<form id="pagerForm" method="post" action="ajax/dh/douser.php">
...
<div class="pageContent">
	...
	<table class="table" layoutH="45" targetType="dialog" width="100%">
		...
		<tbody>
			...
			$resultnow=mysqli_query($con,"select * from t_user  limit ".$sr.",".$er );
			...
			<a class="btnSelect" href="javascript:$.bringBack({id:'<?php echo $resultnowarray[$a]['id'];?>', douser<?php echo $i;?>:'<?php echo $resultnowarray[$a]['username'];?>'})" title="查找带回">选择</a></td>
<?php			
}
