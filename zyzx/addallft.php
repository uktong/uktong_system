...
<!-- db/gsxx.php?type=ajax&action=charu -->
 <form  onsubmit="return navTabSearch(this);" class="pageForm" action="zyzx/jdft.php?action=charu" method="post"  enctype="multipart/form-data">
       ...
       <table cellpadding="0" border="0" cellspacing="0" class="edittable" >
		...
		<input type="hidden" name="jdian134.id" value=""/>
				<input type="text" class="getjdian134 requred" style="width:70%;" oninput="getjdian(134);" name="jdian134.jdian134" value="" suggestFields="jdian134"   lookupGroup="jdian134" />
               <a class="btnLook" style="float: right;" href="ajax/dh/jdian.php?id=134" lookupGroup="jdian134">选择酒店</a>
               </td>
                    <td align="left"  class="editcellverify" style="width:5%;"></td>
                </tr>
                <tr>
