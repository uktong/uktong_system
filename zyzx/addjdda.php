...
<!-- db/gsxx.php?type=ajax&action=charu -->
 <form  onsubmit="return navTabSearch(this);" class="pageForm" action="zyzx/jdda.php?action=charu" method="post"  enctype="multipart/form-data">
       ...
       <table cellpadding="0" border="0" cellspacing="0" class="edittable" >
            <tbody>
                ...
                <tr>
                 <td align="right" class="editcellmessage" style="width:15%;">公司类型：</td>
                   <td align="left" class="editcell" style="width:30%;"><input name="hoteltype"  id="traveltype" type="text" ltype="text" ligerui="{width:180}" /></td>
                     <td align="left" class="editcellverify" style="width:5%;"></td>
                    <td align="right"  class="editcellmessage" style="width:15%;">公司级别：</td>
...
<?php }?>
                ...
                <tr><td align="right" class="editcellmessage" style="width:15%;">联系人：</td>
                   <td align="left" class="editcell" style="width:30%;"><input name="linkpeople"  id="linkpeople" type="text" ltype="text" ligerui="{width:160}" /></td>
                     <td align="left" class="editcellverify" style="width:5%;"></td>
