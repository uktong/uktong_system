...
function charu(){
    ...
    $checkname= mysqli_query($con,"select  *from t_jgtravel where travel_name='".$txtCmpName."'");
    if(mysqli_num_rows($checkname)<1){
        $sql="INSERT INTO t_jgtravel(
...
function edit(){
    ...
    $txtRemark=$_POST["txtRemark"];
    $id=$_GET["id"];
    $checkname= mysqli_query($con,"update  t_jgtravel set
...
function shanchu(){
    require $_SESSION["ROOT"].'/db/db.php';
    $id=$_GET["id"];
    mysqli_query($con, "delete from t_jgtravel where id=".$id);
}
?>
<script type="text/javascript" src="ajax/js/main.js"></script>

<form id="pagerForm" method="post" action="xtgl/jgsda.php">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="zyzx/jgsda.php" method="post" >
	<div class="searchBar">
      <span>旅行社名称</span>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="zyzx/addjgsda.php" target="dialog" mask="true" width="700" height="600"><span>添加</span></a></li>
		</ul>
...
<!-- 				<th align="center">销售</th> -->
		...
		<tbody id="datacontent" >
			...
			<a href='zyzx/showjgsda.php?id=<?php echo$resultnowarray[$a]['id'];?>' class='btnView' id=''target='dialog' mask='true' width='700' height='600' style='color:blue;'>查看</a>
			<a href='zyzx/editjgsda.php?id=<?php echo$resultnowarray[$a]['id'];?>' class='btnEdit' id=''target='dialog' mask='true' width='700' height='600' style='color:blue;'>修改</a>
			<a href='zyzx/jgsda.php?id=<?php echo$resultnowarray[$a]['id'];?>&action=delete' class='btnDel' id='' target="navTab" rel="jgsda" style='color:blue;'>删除</a>
</td></tr>
<?php			
}
