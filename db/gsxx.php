...
function charu(){
    ...
    $checkname= mysqli_query($con,"select  *from t_hotel where hotelname='".$txtCmpName."'");
    if(mysqli_num_rows($checkname)<1){
        $sql="INSERT INTO t_hotel(
hotelname,hotelcode,hotelleader,hotelphone,hoteltel,hotelfax,hoteladdress,hotelzipCode,
hotelbank,hotelbankNum,hotelbankAccount,hotelremark,hotelcityid,hotelisUse,createtime
) VALUES
