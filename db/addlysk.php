...
,'".$arr[$a]."')");
    ...
    mysqli_query($con, "insert into t_sktravel(sk,dodate,paytype,invoice,money,dopeople,dopeoplename,account,remark,mhaving,plan,gddate)values(
			'".$travel."','".$startDate."',
'".$paytype."','".$invoice."','".$money."','".$payuser."','".$payusername."',
    ...
    mysqli_close($con);
    echo '{ "statusCode":"200", "message":"添加成功", "navTabId":"lysk", "rel":"", "callbackType":"closeCurrent", "forwardUrl":"cwgl/lysk.php", "confirmMsg":"" }';
...
function edit(){
    ...
    //修改下账信息
    mysqli_query($con, "update t_sktravel  set sk='".$travel."',money='".$money."',dodate='".$startDate."',
...
,'".$arr[$a]."')");
    ...
    mysqli_close($con);
    echo '{ "statusCode":"200", "message":"修改成功", "navTabId":"lysk", "rel":"", "callbackType":"closeCurrent", "forwardUrl":"cwgl/lysk.php", "confirmMsg":"" }';
