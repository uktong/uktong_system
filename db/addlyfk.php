...
,'".$startDate."','".$reid."')");
    ...
    mysqli_query($con, "insert into t_sktravel(jgs,dodate,paytype,invoice,money,dopeople,dopeoplename,account,
...
'".$paytype."','".$invoice."','".$money."','".$payuser."','".$payusername."',
    ...
    mysqli_close($con);
    echo '{ "statusCode":"200", "message":"添加成功", "navTabId":"lyfk", "rel":"", "callbackType":"closeCurrent", "forwardUrl":"cwgl/lyfk.php", "confirmMsg":"" }';
...
function edit(){
    ...
    //修改下账信息
    mysqli_query($con, "update t_sktravel  set jgs='".$hotel."',money='".$money."',dodate='".$startDate."',
...
,'".$startDate."','".$reid."')");
    ...
    mysqli_close($con);
    echo '{ "statusCode":"200", "message":"修改成功", "navTabId":"lyfk", "rel":"", "callbackType":"closeCurrent", "forwardUrl":"cwgl/lyfk.php", "confirmMsg":"" }';
